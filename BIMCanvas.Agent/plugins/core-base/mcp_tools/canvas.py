...
10 个工具通过 register(builder) 范式注册:
- 6 个通用 BIM 能力:request_background_screenshot / validate_layout /
  get_zone_boundaries / register_variant / list_variants / analyze_image
...
# ============================================================
# register(builder) — 平台调用入口,10 个工具的注册地
# ============================================================
...
def register(builder: McpServerBuilder) -> None:
    ...
    # ---------- get_zone_boundaries ----------
    @builder.tool("get_zone_boundaries", _GET_ZONE_BOUNDARIES_DESC, _GET_ZONE_BOUNDARIES_SCHEMA)
