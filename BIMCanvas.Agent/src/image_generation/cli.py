...
4. 允许做适度图形抽象：保留家具的外轮廓和主功能，但去掉原图中的家具内部细节、软包褶皱、把手、缝线、枕头、床品纹理、洁具内部结构等细碎内容。
5. 墙体、柜体、家具请尽量使用纯色块面和清晰轮廓，不要保留墙体内部填充图案、剖面斜线、CAD 杂线、尺寸辅助线、隐藏线或施工纹样。
6. 输出必须是清晰的 2D 正投影平面图，不要透视、不要 3D、不要照片感、不要真实材质、不要光影、不要体积渲染。
7. 如果第一张图与第二张图冲突，永远服从第一张图的结构与布局，只借用第二张图的配色与图形语言。"""
